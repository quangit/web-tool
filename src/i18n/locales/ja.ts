export const ja = {
  ...
  // Typing Practice
  'typing_practice.title': 'タイピング練習',
  'typing_practice.description':
    '10本指のタッチタイピングを学びましょう。初級から上級までのガイド付きレッスンで練習できます。視覚的な指ガイドでタイピングの速度と正確さを向上させましょう。',
  'typing_practice.select_lesson': 'レッスンを選択',
  'typing_practice.lesson_home_row': 'ホームロー (ASDF JKL;)',
  'typing_practice.lesson_home_row_extended': 'ホームロー拡張 (+ GH)',
  'typing_practice.lesson_top_row': '上段 (QWERTY)',
  'typing_practice.lesson_bottom_row': '下段 (ZXCV)',
  'typing_practice.lesson_all_letters': 'すべての文字',
  'typing_practice.lesson_numbers': '数字',
  'typing_practice.lesson_symbols': '記号',
  'typing_practice.lesson_full': 'フル練習',
  'typing_practice.finger_guide': '指ガイド',
  'typing_practice.left_pinky': '左小指',
  'typing_practice.left_ring': '左薬指',
  'typing_practice.left_middle': '左中指',
  'typing_practice.left_index': '左人差し指',
  'typing_practice.right_index': '右人差し指',
  'typing_practice.right_middle': '右中指',
  'typing_practice.right_ring': '右薬指',
  'typing_practice.right_pinky': '右小指',
  'typing_practice.thumb': '親指',
  'typing_practice.wpm': 'WPM',
  'typing_practice.accuracy': '正確さ',
  'typing_practice.errors': 'エラー',
  'typing_practice.time': '時間',
  'typing_practice.restart': '再開',
  'typing_practice.next_lesson': '次のレッスン',
  'typing_practice.show_keyboard': 'キーボードを表示',
  'typing_practice.show_hands': '手のガイドを表示',
  'typing_practice.show_instructions': '説明を表示',
