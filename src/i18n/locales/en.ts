export const en = {
  ...
  // Typing Practice
  'typing_practice.title': 'Typing Practice',
  'typing_practice.description':
    'Learn touch typing with 10-finger technique. Practice with guided lessons from easy to advanced. Improve your typing speed and accuracy with visual finger guides.',
  'typing_practice.select_lesson': 'Select Lesson',
  'typing_practice.lesson_home_row': 'Home Row (ASDF JKL;)',
  'typing_practice.lesson_home_row_extended': 'Home Row Extended (+ GH)',
  'typing_practice.lesson_top_row': 'Top Row (QWERTY)',
  'typing_practice.lesson_bottom_row': 'Bottom Row (ZXCV)',
  'typing_practice.lesson_all_letters': 'All Letters',
  'typing_practice.lesson_numbers': 'Numbers',
  'typing_practice.lesson_symbols': 'Symbols',
  'typing_practice.lesson_full': 'Full Practice',
  'typing_practice.finger_guide': 'Finger Guide',
  'typing_practice.left_pinky': 'Left Pinky',
  'typing_practice.left_ring': 'Left Ring',
  'typing_practice.left_middle': 'Left Middle',
  'typing_practice.left_index': 'Left Index',
  'typing_practice.right_index': 'Right Index',
  'typing_practice.right_middle': 'Right Middle',
  'typing_practice.right_ring': 'Right Ring',
  'typing_practice.right_pinky': 'Right Pinky',
  'typing_practice.thumb': 'Thumb',
  'typing_practice.wpm': 'WPM',
  'typing_practice.accuracy': 'Accuracy',
  'typing_practice.errors': 'Errors',
  'typing_practice.time': 'Time',
  'typing_practice.restart': 'Restart',
  'typing_practice.next_lesson': 'Next Lesson',
  'typing_practice.show_keyboard': 'Show Keyboard',
  'typing_practice.show_hands': 'Show Hands Guide',
  'typing_practice.show_instructions': 'Show Instructions',
